    ...
    <>
      ...
      >
        <div className="max-w-[1600px] mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {/* Search Bar - Desktop */}
          <div className="hidden xl:flex items-center flex-1 max-w-sm mx-12">
            <div className="relative w-full group">
              <input
                ...
                className="w-full bg-emerald-950/5 border border-emerald-950/10 rounded-2xl py-2 pl-4 pr-10 text-[10px] font-bold uppercase tracking-widest placeholder:text-emerald-950/20 focus:outline-none focus:ring-2 focus:ring-amber-400/20 focus:border-amber-400 transition-all"
              />
              <div className="absolute right-3 top-1/2 -translate-y-1/2 text-emerald-950/20 group-focus-within:text-amber-500 transition-colors">
