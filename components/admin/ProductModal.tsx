              ...
              <div className="relative z-10 space-y-8">
                 ...
                 <div className="pt-12 space-y-6">
                    <div className="flex items-center gap-4 group">
                       ...
                       <p className="text-[11px] font-bold text-emerald-50/60 uppercase tracking-widest">Détails de l &apos; Essence</p>
                    </div>
                    <div className="flex items-center gap-4 group opacity-50">
                       <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center border border-white/5 group-hover:bg-[#C9A84C]/20 transition-all">
                          <LayoutGrid size={18} className="text-white" />
                       </div>
                       <p className="text-[11px] font-bold text-emerald-50/60 uppercase tracking-widest">Taxonomie</p>
                    </div>
                 </div>
              </div>

              <div className="relative z-10 p-8 rounded-3xl bg-white/5 border border-white/5 backdrop-blur-sm">
                 <p className="text-[10px] font-black uppercase tracking-widest text-[#C9A84C] mb-2 flex items-center gap-2">
                    <Sparkles size={12} /> Conseil Amouris
                 </p>
                 ...
                 <section className="p-12 bg-neutral-100/40 rounded-[3rem] border border-emerald-950/5 space-y-12">
                    ...
                    <div className="space-y-6 text-right">
                       ...
                       <div className="flex flex-wrap gap-3">
                          ...
                          <button type="button" className="w-10 h-10 rounded-xl border-2 border-dashed border-emerald-950/10 flex items-center justify-center text-emerald-950/20 hover:text-[#C9A84C] hover:border-[#C9A84C]/40 transition-all">
                             <Plus size={16} />
                          </button>
                       </div>
                    </div>
