    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-xl max-h-[90vh] p-0 overflow-hidden bg-white rounded-3xl border-none shadow-2xl font-sans flex flex-col">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-emerald-100/40 text-[10px] uppercase tracking-widest font-black">Curation Collective Amouris</p>
              </div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar">
          <form id="collection-modal-form" onSubmit={handleSubmit} className="p-8">
              ...
              {activeTab === 'details' ? (
                ...
                >
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-700 flex items-center gap-2"><Type size={12} /> Titre FR</label>
                    <input 
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-700 text-right flex items-center justify-end gap-2">عنوان المجموعة بالعربية <Globe size={12} /></label>
                    <input 
                      ...
                      <AnimatePresence mode="wait">
                        {formData.cover_image ? (
                          ...
                          <motion.label key="upload" className={`w-full h-full flex flex-col items-center justify-center cursor-pointer hover:bg-white transition-all ${isUploading ? 'opacity-50 pointer-events-none' : ''}`}>
                            ...
                            <p className="font-serif text-lg italic text-emerald-950">Importer le visuel de couverture</p>
                            <p className="text-[10px] font-black uppercase tracking-widest text-[#C9A84C] mt-2">Format Recommandé: 21:9</p>
        ...
        <div className="p-8 border-t border-gray-100 shrink-0">
           <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100/50 mb-8">
              ...
              <p className="text-xs text-amber-900/60 italic leading-relaxed">
                 Les éditions limitées sont mises en avant dans le catalogue global pour créer l'exclusivité.
              </p>
           </div>
           ...
           <div className="flex gap-4">
              ...
              <button 
                form="collection-modal-form" type="submit" disabled={isSubmitting || isUploading}
